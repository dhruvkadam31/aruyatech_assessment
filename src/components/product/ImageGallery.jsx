  ...
  return (
    <div className="mt-8">
      ...
      <div className="group relative overflow-hidden rounded-2xl border border-gray-200">
        ...
        {/* Image Counter */}
        <div className="absolute bottom-4 left-1/2 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-200 bg-black/60 text-white px-3 py-1 rounded-full text-sm">
